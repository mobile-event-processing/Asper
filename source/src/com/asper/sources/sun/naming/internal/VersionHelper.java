...
public abstract class VersionHelper {
    ...
    final static String[] PROPS = new String[] {
    	com.asper.sources.javax.naming.Context.INITIAL_CONTEXT_FACTORY,
    	com.asper.sources.javax.naming.Context.OBJECT_FACTORIES,
    	com.asper.sources.javax.naming.Context.URL_PKG_PREFIXES,
    	com.asper.sources.javax.naming.Context.STATE_FACTORIES,
    	com.asper.sources.javax.naming.Context.PROVIDER_URL,
    	com.asper.sources.javax.naming.Context.DNS_URL,
        // The following shouldn't create a runtime dependence on ldap package.
    	com.asper.sources.javax.naming.ldap.LdapContext.CONTROL_FACTORIES
    };
