...
package no.uio.asper.sources.sun.reflect.generics.reflectiveObjects;


import java.lang.reflect.Type;
import java.lang.reflect.WildcardType;
import no.uio.asper.sources.sun.reflect.generics.factory.GenericsFactory;
import no.uio.asper.sources.sun.reflect.generics.tree.FieldTypeSignature;
import no.uio.asper.sources.sun.reflect.generics.visitor.Reifier;
...
public class WildcardTypeImpl extends LazyReflectiveObjectGenerator
    ...
    public java.lang.reflect.Type[] getUpperBounds() {
        ...
        if (upperBounds == null) {
            ...
            for ( int j = 0; j  < fts.length; j++) {
                ...
                fts[j].accept(r);
                ts[j] = (Type) r.getResult();
            }
            // cache result
            upperBounds = ts;
            // could throw away upper bound ASTs here; thread safety?
        }
        return (java.lang.reflect.Type[]) upperBounds.clone(); // return cached bounds
    }
    ...
    public java.lang.reflect.Type[] getLowerBounds() {
        ...
        return (java.lang.reflect.Type[]) lowerBounds.clone(); // return cached bounds
    }

    /**
	 * Removed in the context of Esper.
	 */
    /*
