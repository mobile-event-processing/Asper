...
package no.uio.asper.sources.sun.naming.internal;
...
import no.uio.asper.sources.javax.naming.NamingEnumeration;
...
public abstract class VersionHelper {
    ...
    final static String[] PROPS = new String[] {
    	no.uio.asper.sources.javax.naming.Context.INITIAL_CONTEXT_FACTORY,
    	no.uio.asper.sources.javax.naming.Context.OBJECT_FACTORIES,
    	no.uio.asper.sources.javax.naming.Context.URL_PKG_PREFIXES,
    	no.uio.asper.sources.javax.naming.Context.STATE_FACTORIES,
    	no.uio.asper.sources.javax.naming.Context.PROVIDER_URL,
    	no.uio.asper.sources.javax.naming.Context.DNS_URL,
        // The following shouldn't create a runtime dependence on ldap package.
    	no.uio.asper.sources.javax.naming.ldap.LdapContext.CONTROL_FACTORIES
    };
