...
package no.uio.asper.sources.sun.jmx.mbeanserver;

import static no.uio.asper.sources.sun.jmx.mbeanserver.Util.*;

import static no.uio.asper.sources.javax.management.openmbean.SimpleType.*;

import no.uio.asper.sources.sun.jmx.remote.util.EnvHelp;
...
import no.uio.asper.sources.javax.management.JMX;
import no.uio.asper.sources.javax.management.ObjectName;
import no.uio.asper.sources.javax.management.openmbean.ArrayType;
import no.uio.asper.sources.javax.management.openmbean.CompositeData;
import no.uio.asper.sources.javax.management.openmbean.CompositeDataInvocationHandler;
import no.uio.asper.sources.javax.management.openmbean.CompositeDataSupport;
import no.uio.asper.sources.javax.management.openmbean.CompositeDataView;
import no.uio.asper.sources.javax.management.openmbean.CompositeType;
import no.uio.asper.sources.javax.management.openmbean.OpenDataException;
import no.uio.asper.sources.javax.management.openmbean.OpenType;
import no.uio.asper.sources.javax.management.openmbean.SimpleType;
import no.uio.asper.sources.javax.management.openmbean.TabularData;
import no.uio.asper.sources.javax.management.openmbean.TabularDataSupport;
import no.uio.asper.sources.javax.management.openmbean.TabularType;
