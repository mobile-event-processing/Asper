...
package no.uio.asper.sources.apache.xerces.internal.dv.xs;
...
import no.uio.asper.sources.apache.xerces.Constants;
import no.uio.asper.sources.apache.xerces.internal.dv.DatatypeException;
import no.uio.asper.sources.apache.xerces.internal.dv.InvalidDatatypeFacetException;
import no.uio.asper.sources.apache.xerces.internal.dv.InvalidDatatypeValueException;
import no.uio.asper.sources.apache.xerces.internal.dv.ValidatedInfo;
import no.uio.asper.sources.apache.xerces.internal.dv.ValidationContext;
import no.uio.asper.sources.apache.xerces.internal.dv.XSFacets;
import no.uio.asper.sources.apache.xerces.internal.dv.XSSimpleType;
import no.uio.asper.sources.apache.xerces.xpath.regex.RegularExpression;
import no.uio.asper.sources.apache.xerces.xs.SchemaSymbols;
import no.uio.asper.sources.apache.xerces.xs.util.ObjectListImpl; 
import no.uio.asper.sources.apache.xerces.xs.util.ShortListImpl;
import no.uio.asper.sources.apache.xerces.xs.util.StringListImpl;
import no.uio.asper.sources.apache.xerces.xs.util.XSObjectListImpl;
import no.uio.asper.sources.apache.xerces.util.XMLChar;
import no.uio.asper.sources.apache.xerces.xni.NamespaceContext;
import no.uio.asper.sources.apache.xerces.xs.ShortList;
import no.uio.asper.sources.apache.xerces.xs.StringList;
import no.uio.asper.sources.apache.xerces.xs.XSAnnotation;
import no.uio.asper.sources.apache.xerces.xs.XSConstants;
import no.uio.asper.sources.apache.xerces.xs.XSFacet;
import no.uio.asper.sources.apache.xerces.xs.XSMultiValueFacet;
import no.uio.asper.sources.apache.xerces.xs.XSNamespaceItem;
import no.uio.asper.sources.apache.xerces.xs.XSObject;
import no.uio.asper.sources.apache.xerces.xs.XSObjectList;
import no.uio.asper.sources.apache.xerces.xs.XSSimpleTypeDefinition;
import no.uio.asper.sources.apache.xerces.xs.XSTypeDefinition;
import no.uio.asper.sources.apache.xerces.xs.datatypes.ObjectList;
...
public class XSSimpleTypeDecl implements XSSimpleType, TypeInfo {
    ...
    private static final class XSMVFacetImpl implements XSMultiValueFacet {
        ...
        // short, StringList, ObjectListImpl, XSObjectList
